<?php
    ...
    class booking_package_setting {
        ...
        public $member_setting = array(
            ...
            'check_email_for_member' => array('name' => 'Confirm whether the user\'s email address exists', 'value' => '0', 'isExtensionsValid' => 1, 'inputLimit' => 1, 'inputType' => 'CHECK', 'valueList' => array('0' => 'Enabled')), 
        ...
        **/
        ...
        public function couponsInputType(){
            ...
            $couponsInputTypeList = array(
                ...
                'target' => array('key' => 'target', 'name' => __('Target customers', $this->pluginName), 'value' => 'customers', 'inputLimit' => 1, 'inputType' => 'RADIO', 'target' => 'both', 'valueList' => array('visitors' => __('Visitors', $this->pluginName), 'users' => __('Users', $this->pluginName)), "class" => ""),
            ...
            $list =  array(
                "General" => array(
                    ...
                    **/
                    ...
                    'monitorNumberOfShortcode' => array('name' => __('Monitor the number of shortcode calls', $this->pluginName), 'value' => 1, 'isExtensionsValid' => 0, 'inputLimit' => 2, 'inputType' => 'CHECK', 'valueList' => array('1' => __('Enabled', $this->pluginName))), 
                ...
                "twilio" => array(
                    ...
                    'twilio_sendingMethod' => array('name' => __('Sending method', $this->pluginName), 'value' => 'phoneNumber', 'isExtensionsValid' => 1, 'inputLimit' => 1, 'inputType' => 'RADIO', 'valueList' => array('phoneNumber' => __('Phone number', $this->pluginName), 'senderID' => __('Alpha Sender ID', $this->pluginName))), 
        ...
        public function getElementForCalendarAccount(){
            ...
            $calendarAccount = array(
                ...
                **/
                ...
                'bookingVerificationCode' => array('key' => 'bookingVerificationCode', 'name' => __('Send a booking verification code to customer', $this->pluginName), 'target' => 'both', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 1, 'option' => 0, 'valueList' => array('emailAndSms' => __('Enabled', $this->pluginName) . ' - ' . __('Email and SMS', $this->pluginName), 'email' => __('Enabled', $this->pluginName) . ' - ' . __('Email', $this->pluginName), 'sms' => __('Enabled', $this->pluginName) . ' - ' . __('SMS', $this->pluginName), 'false' => 'Disabled')),
                ...
                **/
                ...
                'courseBool' => array('key' => 'courseBool', 'name' => __('Enable the service function', $this->pluginName), 'target' => 'day', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array(1 => 'Enabled', 0 => 'Disabled')),
                ...
                'guestsBool' => array('key' => 'guestsBool', 'name' => __('Enable the guests function', $this->pluginName), 'target' => 'day', 'value' => 'false', 'inputLimit' => 1, 'inputType' => 'RADIO', 'isExtensionsValid' => 0, 'option' => 0, 'valueList' => array(1 => 'Enabled', 0 => 'Disabled')),
        ...
        public function update($post){
            ...
            $extentionBool = $this->getSiteStatus(false);
            $list = $this->getList();
        ...
        **/
        ...
        public function updateGuests($accountKey = false){
            ...
            if($accountKey != false){
                ...
                if(isset($_POST['json'])){
                    ...
                    if (isset($_POST['costInServices']) && $this->getSiteStatus() === true) {
        ...
        public function addCourse(){
            ...
            for ($i = 1; $i <= 6; $i++) {
                ...
                if ($i > 1 && $this->getSiteStatus() === false) {
        ...
        public function updateCourse(){
            ...
            if (isset($_POST['options'])) {
                ...
                if ($this->getSiteStatus(false) === false) {
        ...
        public function updateChannelGC($calendarAccountList){
    		...
    		if(intval($bookingSync['booking_package_googleCalendar_active']['value']) == 1){
    		    ...
    		    if($this->getSiteStatus(false) === true){
        ...
        public function listsGC($accountKey, $googleCalendarID, $timeMin){
    		...
    		if(intval($bookingSync['booking_package_googleCalendar_active']['value']) == 1){
    			...
    			#var_dump($this->getSiteStatus(false));
    			if($this->getSiteStatus(false) === true){
