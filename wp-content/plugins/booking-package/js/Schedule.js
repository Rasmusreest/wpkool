...
function SCHEDULE(schedule_data, booking_package_dictionary, webApp) {
    ...
    this.editScheduleForHotel = function(month, scopeOfDay, year, account, scheduleList, callback){
    	...
    	var titleList = [object._i18n.get("Date"), object._i18n.get("State")/**, object._i18n.get("Receptionist")**/, object._i18n.get("Price"), object._i18n.get("Number of rooms available"), object._i18n.get('Remainders')];
    	var tr = document.createElement("tr");
    ...
    this.editTemplateSchedule = function(weekKey, account){
        ...
        for(var i = 0; i < weekList.length; i++){
            ...
            div.onclick = function(){
                ...
                edit_title.textContent = object._i18n.get("Schedule every %s", [object._i18n.get(weekList[key])]);
    ...
    this.createCouponsListPanel = function(couponsList, account, callback) {
        ...
        addButton.textContent = object._i18n.get("Add Coupon");
        ...
        var directlySwitchPanel = object.createSwitchPanel( account, 'couponsBool', 'directlySwitchForGuests', 'switch2', 'Enable the coupons function', 'updateAccountFunction', function(json) {
        ...
        for(var key in couponsList){
            ...
            deleteLabel.onclick = function(event){
                ...
                if(editBool === true){
                    ...
                    var result = confirm(object._i18n.get('Do you delete filed of "%s"?', [couponsList[dataKey].name]));
                    if(result === true){
    ...
    this.createGuestsPanel = function(guestsList, account, callback){
    	...
    	var directlySwitchPanel = object.createSwitchPanel( account, 'guestsBool', 'directlySwitchForGuests', 'switch1', 'Enable the guests function', 'updateAccountFunction', function(json) {
    ...
    this.createCoursePanel = function(courseList, account, callback){
        ...
        **/
        ...
        var directlySwitchPanel = object.createSwitchPanel( account, 'courseBool', 'directlySwitchForServices', 'switch1', 'Enable the service function', 'updateAccountFunction', function(json) {
