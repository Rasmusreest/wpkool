            ...
            if (post !== false) {
                ...
                xmlHttp = new Booking_App_XMLHttp(url, post, false, function(response){
                    ...
                    if (response.status === true) {
                        ...
                        //var notificationsLabel = verificationCodeContent.getElementsByClassName('notifications')[0];
                        //notificationsLabel.textContent = object._i18n.get('We sent a verification code to %s.', [response.notifications]);
